 ...
 */
@Component
@RocketMqConsumer(topic = "feizi_topic", selectorExpress = "tagB", consumerGroup = "my_consumer_group1")
public class MyConsumer2 implements RocketMqConsumerListener<Message> {
    private static final Logger LOGGER = LoggerFactory.getLogger(MyConsumer2.class);

    @Override
    public boolean consume(Message message) {
        LOGGER.info("==========================MyConsumer2 start=====================");
